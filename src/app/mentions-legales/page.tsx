...
export default function Page() {
    return (
        <>
            <div>
                ...
                <div className={"bg-gradient-to-b from-0% from-custom_blue_black to-10% to-white"}>
                    <section className={"flex flex-col items-center gap-5 pt-10"}>
                        ...
                        <p className={"px-5 text-center"}>Découvrez nos mentions légales pour en savoir plus sur les
                            informations légales relatives à notre entreprise, y compris les conditions d'utilisation,
                            la politique de confidentialité, et les détails de contact.</p>
            ...
            <div className={"flex flex-col sm:items-center gap-3 px-10"}>
                ...
                <div className={"flex flex-col gap-5 border-b-except-last"}>
                    ...
                    <div className={"flex flex-col gap-5 items-center py-3"} id={"intellectual-property"}>
                        ...
                        <div className={"border-2 border-custom_yellow rounded-lg p-3"}>
                            <p className={"text-center font-medium sm:w-[30rem]"}>L'intégralité du contenu du site PSDOweb est
                                protégée
                                par les lois françaises et
                                internationales relatives à la propriété intellectuelle. Tous les droits de reproduction
                                sont réservés, y compris les documents téléchargeables et les représentations
                    ...
                    <div className={"flex flex-col gap-5 items-center py-3"} id={"utilisation"}>
                        ...
                        <div className={"border-2 border-custom_yellow rounded-lg p-3"}>
                            <p className={"text-center font-medium sm:w-[30rem]"}>L'utilisation du site PSDOweb implique
                                l'acceptation
                                pleine et entière des conditions générales d'utilisation décrites ci-après. Ces
                                conditions
                                d'utilisation peuvent être modifiées ou complétées à tout moment, les utilisateurs du
                                site
                                [Nom du site] sont donc invités à les consulter de manière régulière.
                            </p>
                        </div>
                    </div>
                    <div className={"flex flex-col gap-5 items-center py-3"} id={"personal-data-protection"}>
                        ...
                        <div className={"border-2 border-custom_yellow rounded-lg p-3"}>
                        <p className={"text-center font-medium sm:w-[30rem]"}>Conformément à la loi Informatique et Libertés du 6
                            janvier 1978 modifiée, vous disposez d’un droit d’accès, de rectification, de modification
                            et de suppression des données vous concernant. Vous pouvez exercer ce droit en envoyant un
                            courrier à l'adresse suivante : [Adresse de votre entreprise] ou par email à [Votre adresse
                            e-mail].
                        </p>
                        </div>
                    </div>
                    ...
                    <p className={"text-2xl font-medium"}>Cookies</p>
                        <div className={"border-2 border-custom_yellow rounded-lg p-3"}>
                            <p className={"text-center font-medium sm:w-[30rem]"}>Le site [Nom du site] peut être amené à vous
                                demander
                                l’acceptation des cookies pour des besoins de statistiques et d'affichage. Un cookie est
                                une
                                information déposée sur votre disque dur par le serveur du site que vous visitez. Il
                                contient plusieurs données qui sont stockées sur votre ordinateur dans un simple fichier
