    ...
    return (
        <main className="">
            ...
            <section
                ...
                <motion.h2 initial={{opacity: 0, x: -100}} animate={{opacity: 1, x: 0}} transition={{duration: 1}}
                           className={"text-[70px] font-semibold mobile:text-4xl mobile:text-center"}>{"Nom de l'entreprise"}</motion.h2>
            ...
            <div className={"bg-[url('/Images/decoration/banner.png')] w-full h-72"}></div>
            ...
            <section className={"flex flex-col items-center gap-10 py-10"}>
                <motion.p initial={{opacity: 0, x: -150}} whileInView={{opacity: 1, x: 0}} transition={{duration: 0.5, ease: "easeInOut"}}
                ...
                <motion.div initial={{scale: 0}} whileInView={{scale: 1}} transition={{type: "spring", bounce: 0.25}}
                            viewport={{once: true}}>
                    <motion.div initial={{scale: 1}} whileHover={{scale: 1.05}}>
                        <Link href={'/contact'} className={"bg-custom_yellow px-20 mobile:px-10 rounded-md py-3 text-xl"}>Contactez-nous
                            →</Link>
                    </motion.div>
                </motion.div>
            </section>
            ...
            <section className={"flex flex-col items-center gap-10 mobile:gap-5 py-20"}>
                ...
                <div className={"flex mobile:flex-col mobile:items-center gap-20"}>
                    <motion.div initial={{opacity: 0, y: -30}} animate={{opacity: 1, y: 0}} transition={{duration: 0.5, delay: 0}} className={"flex flex-col items-center gap-3"}>
                        <Image src={'/Images/home/innovation.png'} alt={'Innovation'} width={80} height={80}></Image>
                        <p>Innovation</p>
                    </motion.div>
                    <motion.div initial={{opacity: 0, y: -30}} whileInView={{opacity: 1, y: 0}} transition={{duration: 0.5, delay: 0.5}} className={"flex flex-col items-center gap-3"}>
                        <Image src={'/Images/home/fiabilite.png'} alt={'Fiabilité'} width={80} height={80}></Image>
                        <p>Fiabilité</p>
                    </motion.div>
                    <motion.div initial={{opacity: 0, y: -30}} whileInView={{opacity: 1, y: 0}} transition={{duration: 0.5, delay: 1}} className={"flex flex-col items-center gap-3"}>
                        <Image src={'/Images/home/creativite.png'} alt={'Creativite'} width={80} height={80}></Image>
                        <p>Créativité</p>
                    </motion.div>
                    <motion.div initial={{opacity: 0, y: -30}} whileInView={{opacity: 1, y: 0}} transition={{duration: 0.5, delay: 1.5}} className={"flex flex-col items-center gap-3"}>
                        <Image src={'/Images/home/personnalisation.png'} alt={'Personnalisation'} width={80}
                               height={80}></Image>
                        <p>Personnalisation</p>
                    </motion.div>
                </div>
                <motion.p initial={{opacity: 0}} whileInView={{opacity: 1}} transition={{duration: 1, delay: 2}} viewport={{once: true}}>Vous cherchez des idées ou vous en avez déjà :</motion.p>
