...
export default function Construisons() {
  return (
    <main>
      <title>Construisons Ensemble</title>
      ...
      <section className="relative bg-gradient-to-t from-0% from-custom_blue_black to-10% to-white py-5 md:flex md:flex-row-reverse md:items-center lg:px-60 lg:gap-5">
        <motion.div initial={{ opacity: 0, x: 40 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 1, delay: 0.5 }} viewport={{ once: true }} className=" justify-center items-center m-5">
          <ul className="list-disc flex flex-col gap-12">
            ...
            <li>
              <span className="underline">Accompagnement Sur-Mesure :</span> Nous sommes à vos côtés à chaque étape de votre projet, du concept initial au lancement final. Nous misons sur une communication transparente et régulière pour garantir que chaque détail reflète vos attentes.
            </li>
            <li>
        ...
        <motion.div initial={{ opacity: 0, x: -40 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 1, delay: 0.5 }} viewport={{ once: true }} className="p-3 gap-8 flex flex-col items-center justify-center text-center rounded-[10px] bg-custom_yellow z-50 m-5 md:h-[10%]">
          ...
          <div className="flex justify-center items-center text-xs gap-5">
            <div className="flex flex-col items-center justify-center gap-2">
              <Image src="/Images/home/professionnel.png" alt="professionnel_logo" width={100} height={100} className="w-11" />
              <h3>Professionnel</h3>
            </div>
            <div className="flex flex-col items-center justify-center gap-2">
              <Image src="/Images/home/securite.png" alt="securite_logo" width={100} height={100} className="w-11" />
              <h3>Sécurité</h3>
            </div>
            <div className="flex flex-col items-center justify-center gap-2">
              <Image src="/Images/home/developpement.png" alt="developpement_logo" width={100} height={100} className="w-11" />
              <h3>Développement</h3>
            </div>
            <div className="flex flex-col items-center justify-center gap-2">
              <Image src="/Images/home/originalite.png" alt="originalite_logo" width={100} height={100} className="w-11" />
              <h3>Originalité</h3>
            </div>
          </div>
        </motion.div>
