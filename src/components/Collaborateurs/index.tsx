...
export default function Collaborateurs() {
  return (
    <main>
      ...
      <section id="collab_1_mobile" className=" flex flex-col items-center gap-[22px] px-[10px] py-5 relative">
        ...
        <p className="w-[300px] text-center">Un développeur web compétent en front et back-end, alliant expertise technique et créativité.</p>
        <div>
          <Link href="/nous-contacter" className="flex justify-center items-center w-[343px] h-[41px] bg-custom_yellow rounded-[5px] shadow-lg z-10">
            Mon Site
          </Link>
      ...
      <section id="collab_3_mobile" className=" flex flex-col items-center gap-[22px] px-[10px] py-5 relative">
        <div className="flex flex-col gap-[10px] items-center">
          <div className="rounded-full bg-black w-fit">
            <Image src={"/images/logoBD2.png"} alt="logo_gabin_buignet" width={55} height={55} className="p-1" />
          </div>
          <h2>Gabin Buignet</h2>
        </div>
        <p className="w-[300px] text-center">Un développeur web compétent en front et back-end, alliant expertise technique et créativité.</p>
